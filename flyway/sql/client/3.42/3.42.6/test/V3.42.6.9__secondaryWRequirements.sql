...
/* Create a table type. */
  CREATE TYPE test.permitFields AS TABLE (
    ...
    [ptCanModifySecondaryApprover] [bit] DEFAULT 0,
...
BEGIN
    ...
    SELECT DISTINCT @KIOSKID,ks.kioskSiteUUID
        ...
        ,pt.[ptCanModifySecondaryApprover]
    ...
    SET [permit].[ptIsActive] = [fields].[ptIsActive]
        ...
        ,[permit].[ptCanModifySecondaryApprover] = [fields].[ptCanModifySecondaryApprover]
    ...
    OR ([permit].[ptCanModifySecondaryApprover] != [fields].[ptCanModifySecondaryApprover]
        OR [permit].[ptCanModifySecondaryApprover] IS NULL)
