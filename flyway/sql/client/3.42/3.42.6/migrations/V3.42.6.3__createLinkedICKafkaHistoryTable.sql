...
INSERT INTO permitLinkedICKafkaHistory (permitPublicKey, icID, kioskID, kioskSiteUUID, isActive, linkedUTC, linkedBy, unlinkedUTC, unlinkedBy, updatedUTC, processed, produced, retryCount)
SELECT permitPublicKey, icID, kioskID, kioskSiteUUID, isActive, linkedUTC, linkedBy, unlinkedUTC, unlinkedBy, 
