SET NOCOUNT ON;
DECLARE @DEBUG BIT = 0;
DECLARE @KIOSKID INT = 5066;
DECLARE @ARCHIVED INT = 2;
DECLARE @count INT = 0;
...
VALUES ('Archived Site','Europe/Dublin','en_IE','ddd, mmmm dd, yyyy','d M yy','HH:MM',@CP)
;
...
,CAST(ts.name AS VARCHAR(255)),ts.name,@ARCHIVED
,0,GETUTCDATE()
