...
IF OBJECT_ID('test.create_COSHH_Form') IS NULL
    EXEC ('CREATE PROCEDURE test.create_COSHH_Form AS SELECT 1');
GO

CREATE OR ALTER PROCEDURE test.create_COSHH_Form
(
@name VARCHAR(255)
...
BEGIN
	...
	DECLARE @MODULE_PREFIX VARCHAR(255) = 'coshh';
