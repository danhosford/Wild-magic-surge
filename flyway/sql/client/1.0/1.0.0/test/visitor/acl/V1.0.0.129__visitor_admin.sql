...
-- Description: Visitor Admin breadcrumb features
-- =============================================
...
DECLARE @VISITOR_ADMIN test.GroupFeatures;
INSERT INTO @GROUPNAMES (name)
VALUES ('Visitor Administrator');

INSERT INTO @VISITOR_ADMIN (section,page,appPrefix)
...
,('visitorUser','user','visitor')
,('visitorUser','userAdd','visitor')
