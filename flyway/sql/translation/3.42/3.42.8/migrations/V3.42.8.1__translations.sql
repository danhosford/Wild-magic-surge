...
VALUES (2335, 1, '258f3d31-426b-4b22-94ac-9dc5d94efdad', '', '', N'If you are not receiving the password reset link email, be sure to check your “junk” folder and that you are using the same email address provided to the site point of contact. For further assistance, view our %s'),
        (2336, 1, '369b687e-8815-4308-bb83-33519a0824df', '', '', N'login and password reset support guide.')
;
