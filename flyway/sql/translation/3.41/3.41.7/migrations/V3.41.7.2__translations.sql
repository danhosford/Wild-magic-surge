...
-- Description:
-- * 20/07/2023 - LK - New translation for pre approver signature
--====================================================================================================================

IF OBJECT_ID('tempdb..#translations') IS NOT NULL DROP TABLE #translations;
GO

-- Create tempoary table translations
...
VALUES (2282,1,'1be34e4d-aec0-4a37-8a61-25bf8712b1dc','','',N'Pre Approver Signature - %s, %s')
;
